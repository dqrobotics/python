...
void init_DQ_py(py::module& m)
{
    ...
    dq.def("Q4"                  ,&DQ::Q4,                    "Retrieves the partial derivative of the unit quaternion with respect to its logarithm.");
    dq.def("Q8"                  ,&DQ::Q8,                    "Retrieves the partial derivative of a DQ with respect to its logarithm.");
    ...
    m.def("Q4"                  ,&DQ_robotics::Q4,                   "Retrieves the partial derivative of the unit quaternion with respect to its logarithm.");
    m.def("Q8"                  ,&DQ_robotics::Q8,                   "Retrieves the partial derivative of a DQ with respect to its logarithm.");
